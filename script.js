...
(function() {
    ...
    function openLightbox(index) {
        ...
        // Añadir clic en imagen para cambiar foto (móvil)
        ...
        if (lightboxImage) {
            lightboxImage.onclick = (e) => {
                ...
                // Clic en la mitad izquierda = anterior, derecha = siguiente
    ...
    function updateLightboxImage() {
        ...
        setTimeout(() => {
            ...
            // Esperar a que la imagen cargue antes de mostrar
            lightboxImage.onload = () => {
                lightboxImage.style.opacity = '1';
            };
            
            // Fallback si la imagen ya estaba cacheada
